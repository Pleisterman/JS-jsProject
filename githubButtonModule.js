 ...
 * 
 *  File: githubButtonModule.js
 * 
 *  Purpose: 
 *      creates the github button
 *  
...
( function( pleisterman ){
    ...
    // MODULE: githubButtonModule( html element id: parentId ) void
    
    pleisterman.githubButtonModule = function( parentId ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                                // object: self
        self.MODULE = 'githubButtonModule';                              // string: module
        self.debugOn = true;                                            // boolean: debugOn
        self.parentId = parentId;                                       // html element id: parentId 
        self.buttonOptions = {                                          // json: buttonOptions
            'id'                            :   self.parentId + 'githubButton', // string: id
            'element'                       :   'a',                    // string: html element type 
            'target'                        :   '_blank',               // html target
            'href'                          :   'https://github.com/Pleisterman/jsProject', // html href
    ...
    // DONE MODULE: githubButtonModule( html element id: parentId ) void
})( pleisterman );
