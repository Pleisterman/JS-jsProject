...
( function( pleisterman ){
    ...
    pleisterman.translationsModule = function( ) {
        ...
        self.contentText =  '<div>';
            self.contentText += 'Er zijn een aantal standaard functies in jsProject ingebouwd die veel gebruikt worden door een applicatie.';
        self.contentText += '</div>';
        self.contentText += '<br>';
        self.contentText +=  '<div>';
            self.contentText += 'Je roept een functie aan met:';
        self.contentText += '</div>';
        self.contentText += '<br>';
        ...
        self.contentText += '<br>';
        self.contentText +=  '<div>';
            self.contentText += 'Momenteel ingebouwde functies:';
        self.contentText += '</div>';
        self.contentText += '<br>';
        self.contentText +=  '<div>';
